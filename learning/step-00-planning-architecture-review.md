...
- Stronger Bengali learning documentation rules
...
```text
snippet -> Bangla explanation -> file/folder/class purpose -> SmartKash flow -> mistakes -> tests -> Git commands
```
...
Learning file rule snippet-টা বোঝায় যে শুধু কী করা হয়েছে বললেই হবে না; কী code/config লেখা হয়েছে, কেন লেখা হয়েছে, কীভাবে SmartKash flow-তে connect করে, কীভাবে test করতে হয়, এবং কোন Git commands ব্যবহার হয়েছে - সব বাংলায় explain করতে হবে।
...
Learning rule update-এর কারণে Step 01 থেকে প্রতিটি implementation step শেখার মতো করে document হবে। এতে Flutter folder, Spring Boot class, config file, database migration, service logic, DTO, mapper, repository - সব step-by-step বোঝা যাবে।
...
- Learning file শুধু short summary হলে শেখার উদ্দেশ্য পূরণ হবে না।
- Code/config snippets ছাড়া learning file incomplete ধরা হবে।
- Git commands used section বাদ দিলে step history বোঝা কঠিন হবে।
